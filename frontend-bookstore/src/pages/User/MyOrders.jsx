  ...
  return (
    <div className="min-h-screen bg-green-50 text-green-900 font-serif">
      ...
      <div className="py-8 px-4 max-w-6xl mx-auto space-y-6">
        ...
        {orders.length === 0 ? (
          <p className="text-center text-green-500">You have no orders yet.</p>
        ) : (
          orders.map((order) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 space-y-1">
                  <p>
                    <strong>Product:</strong> {order.booktitle} ({order.bookgenre})
                  </p>
                  <p>
                ...
                <div className="flex flex-col text-sm font-medium">
                  ...
                  <span>
                    {order.flatno}, {order.city}, {order.state} ({order.pincode})
                  </span>
                </div>
              </div>
            );
